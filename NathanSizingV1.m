...
% Cargo = 5400;                       %ft^3
Mcruise = 0.7;                        % cruise Mach number
...
SFCcruise = 0.5./(3600);              % Estimate from Raymer from 1/hr to 1/s
...
ClMax = 2;                    % Double slotted flaps (same as 767) fig 5.3
...
W_S = linspace(0,400,1000);         % W/S from 0 to 200
...
W_Sgraph = 300; % Selected W_S and T_W from graph
T_Wgraph = 0.08;
